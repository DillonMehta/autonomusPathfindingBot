...
double left_angle  = 86.95;   // approx. “normal” left turn angle
double right_angle =  84.;   // approx. “normal” right turn angle
const double turnTime = 800;
double full_turn=176;


//straight
double kPs = 0.12;          // small angle correction for going straight
...
char movement[200] = "F30.3 F50 R F50 L F50 L F100 R F50 B F50 L F100 L F50 R F50 R F50 L F50 L F50 B F150 R F50 R F50 B F50 L F50 L F100 L F100 L F50 R F100 L F50 L F50 L F50 R F50 L F50 L F50 E";
...
void fwd(double distance) {
  ...
  while (true) {
    ...
    right_pwm = constrain(right_pwm, str_min + 0.08, 400);
    right_pwm -= kPs * ang();
    // Set motor speeds
