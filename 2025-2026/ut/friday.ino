...
double left_ang = 87.5;
double right_ang = 87.5;
// straight
...
double targetTime = 10; // subtract 1.75 seconds for every 50cm the end has, including the dist_diff
