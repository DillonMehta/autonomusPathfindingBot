...
double left_angle  = 84.95;   // approx. “normal” left turn angle
double right_angle =  82.75;   // approx. “normal” right turn angle
...
//30.3 is enter
//for cali use 30 sec for 2 squares and 8 seconds for 4 backs
char movement[200] = "";
...
double dR(){return eCount2 / (CLICKS_PER_ROTATION * GEAR_RATIO) * (WHEEL_CIRCUMFERENCE-0.022);}
double vL(){
